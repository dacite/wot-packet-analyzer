import * as wasm from './packet_analyzer_bg.wasm';
...
* @returns {any}
*/
export function search_value(needle, from) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(needle, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.search_value(retptr, ptr0, len0, from);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function parse_pickle_stream(stream) {
    try {
        ...
        const ptr0 = passArray8ToWasm0(stream, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_pickle_stream(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export class PacketSearchResult {
    ...
    free() {
        ...
        wasm.__wbg_packetsearchresult_free(ptr);
    }
    /**
    * @returns {number}
    */
    get packet_id() {
        const ret = wasm.__wbg_get_packetsearchresult_packet_id(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set packet_id(arg0) {
        wasm.__wbg_set_packetsearchresult_packet_id(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get offset() {
        const ret = wasm.__wbg_get_packetsearchresult_offset(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set offset(arg0) {
        wasm.__wbg_set_packetsearchresult_offset(this.ptr, arg0);
    }
}
/**
*/
export class PacketSummary {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_packetsummary_free(ptr);
    }
}
...
export function __wbg_log_5ceaa86beffc2913(arg0, arg1) {
